...
import com.example.forlove.databinding.FragmentMassageBinding;

public class MassageFragment extends Fragment {

    private MassageViewModel notificationsViewModel;
    private FragmentMassageBinding binding;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        notificationsViewModel =
                new ViewModelProvider(this).get(MassageViewModel.class);
